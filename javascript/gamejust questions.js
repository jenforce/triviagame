...
$('#startjumbotron').click(function() {     //start game and timer
      ...
      var ques = [
        {"q1":"0.0 one jhrkjehflkjhddqjkjjriejqe",
        "correct":"0 .1correct",
        "answer1":"answer1",
        "answer2":"answer2",
        "answer3":"answer3"
       ...
       {"q1":"0.1 one jhrkjehflkjhddqjkjjriejqe",
        "correct":"0 .2correct",
        "answer1":"answer1",
        "answer2":"answer2",
        "answer3":"answer3"
...
function questionGenerator(){   
       for(var i = 0; i <= ques.length; i++){
        //console.log(ques[(i)]);
        //console.log(ques[(i)].q1);
         //console.log(ques.q1[0][1]);

         var quesbox = $('<div class="questionbox">');  
            var questiontxt = ques[(i)].q1;
            quesbox.append(questiontxt); 

         var ansbox = $('<div class="answerbox">');  
        var answercorrect = ques[(i)].answer1; 
        ansbox.append(answercorrect);
        var rbtn = $('<input type="radio" name="radio_name" />');
        rbtn.attr(<label for="radio_name">jen</label>);

              $("#qContainer").append(quesbox, ansbox, rbtn);
       }
 };        
...
//}// writes questions and answers to screen, random order to questions, random order to answers right answer flag radio buttons for loops and 
